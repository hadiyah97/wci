...
enum class SymTabKeyImpl
{
	...
	// Local variables array index
	VAR_ARRAY_INDEX,

	// Parent function of a variable
	PARENT_FUNCTION
};
...
constexpr SymTabKeyImpl VAR_ARRAY_INDEX = SymTabKeyImpl::VAR_ARRAY_INDEX;
constexpr SymTabKeyImpl PARENT_FUNCTION = SymTabKeyImpl::PARENT_FUNCTION;
